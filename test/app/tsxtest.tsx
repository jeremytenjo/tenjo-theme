    ...
    <KBarProvider
      ...
      actions={[
        ...
        },
        {
          ...
          section: 'Navigation',
          perform: () => window.open('mailto:tenjojeremy@gmail.com', '_blank'),
        },
        {
          id: 'twitterAction',
          name: 'Twitter',
          ...
          section: 'Navigation',
          perform: () => window.open('https://twitter.com/jeremy_tenjo', '_blank'),
        },
        createAction({
          name: 'Github',
          shortcut: ['g', 'h'],
          keywords: 'sourcecode',
          section: 'Navigation',
          perform: () => window.open('https://github.com/jeremytenjo', '_blank'),
        }),
        {
          id: 'projects',
          name: 'Web Apps',
